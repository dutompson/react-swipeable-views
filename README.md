...
[![Build Status](https://travis-ci.org/dutompson/react-swipeable-views.svg?branch=master)](https://travis-ci.org/dutompson/react-swipeable-views)
[![Dependencies](https://img.shields.io/david/dutompson/react-swipeable-views.svg)](https://david-dm.org/dutompson/react-swipeable-views)
[![DevDependencies](https://img.shields.io/david/dev/dutompson/react-swipeable-views.svg)](https://david-dm.org/dutompson/react-swipeable-views#info=devDependencies&view=list)
[![Donate](https://img.shields.io/badge/$-support-green.svg)](https://www.paypal.me/dutompson/10)
...
[![Coverage Status](https://img.shields.io/codecov/c/github/dutompson/react-swipeable-views/master.svg)](https://codecov.io/gh/dutompson/react-swipeable-views/branch/master)
...
[MIT license](https://github.com/dutompson/react-swipeable-views/blob/master/LICENSE).
